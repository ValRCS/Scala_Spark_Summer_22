...
import org.apache.spark.ml.feature.{Bucketizer, ChiSqSelector, CountVectorizer, MinMaxScaler, NGram, PCA, QuantileDiscretizer, RFormula, RegexTokenizer, StopWordsRemover, StringIndexer, Tokenizer, UnivariateFeatureSelector, VectorAssembler}
...
//  /We can see some overlapping words in these documents, but these words provide at least a rough
  ...
  //Word2Vec is available //TODO time allowing
